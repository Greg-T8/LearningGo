...
```
[File: `dup1.go`](duplicate_lines/dup1/dup1.go).
...
```
[File: `dup2.go`](duplicate_lines/dup2/dup2.go).
...
```
[File: `dup3.go`](duplicate_lines/dup3/dup3.go).
...
[File: `dup4.go`](duplicate_lines/ex1_4-dup4/dup4.go).
...
```
[File: `lissajous.go`](animated_gifs/lissajous_1/lissajous.go).

**Output:**  
![File: `lissajous.gif`](animated_gifs/lissajous_1/out.gif).
...
[File: `lissajous.go`](animated_gifs/lissajous_ex1_5/lissajous.go).

**Output:**  
![File: `lissajous.gif`](animated_gifs/lissajous_ex1_5/out.gif)
...
[File: `lissajous.go`](animated_gifs/lissajous_ext1_6/lissajous.go).

**Output:**  
![File: `lissajous.gif`](animated_gifs/lissajous_ext1_6/out.gif)
...
```
[File: `fetch.go`](urls/fetch_1/fetch.go).
...
```
[fetchall.go](concurrency/fetchall_1/fetchall.go)
...
```
[fetchall.go](concurrency/ex1-10/fetchall.go)
...
```
[File: `server.go`](web_server/server4/server.go)
...
See [File: `server.go`](web_server/ex_1.12/server.go).

<img src="web_server/ex_1.12/2025-07-06_04-31-33.gif" width="600" />
